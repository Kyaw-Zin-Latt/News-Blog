...
<div class="row">
    <div class="col-9">
        <div class="row list-wrapper">
            <?php
            $result = count(fPostByDate());
            if ($result == 0){

            ?>
                <div class="col-12">
                    <p class="alert alert-warning card-bg text-white">There is no post</p>
                </div>
            <?php } ?>
        ...
        if ($result == 0){
            ...
            ?>
            <div id="pagination-container" class="align-items-start mt-3 fs d-none"></div>
        <?php } else { ?>
